class TabletHackingNotificationWidget extends Managed
{	
	...
	void TabletHackingNotificationWidget()
    {
		m_Root 			= Widget.Cast(GetGame().GetWorkspace().CreateWidgets("TabletHacking/GUI/Layouts/HackingNotification.layout"));
	...
	void Init(string Heading, string Message, string NotificationIcon = "TabletHacking/GUI/Images/hacking.paa", float timeSeconds = 8)	
	{
